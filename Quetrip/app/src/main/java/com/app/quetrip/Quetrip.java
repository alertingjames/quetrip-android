...
public class Quetrip extends Application {
    public static final String TAG = Quetrip.class.getSimpleName();

    private String m_gsmToken = "";

    private static final String LOG_TAG = "CrashCatch";

    private static Quetrip _instance;

    public static Quetrip getApplication() {
        return _instance;
    }
    ...
    public static synchronized Quetrip getInstance(){
