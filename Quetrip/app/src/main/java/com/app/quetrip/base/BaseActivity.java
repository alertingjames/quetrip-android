...
public class BaseActivity extends LocalizationActivity {
    public Typeface bold, normal, shape, futura, weather, logo;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(Commons.lang.equals("en"))
            setLanguage("en");
        else if(Commons.lang.equals("es"))
            setLanguage("es");
        else if(Commons.lang.equals("pt"))
            setLanguage("pt");
        ...
        logo = Typeface.createFromAsset(getApplicationContext().getAssets(), "DisneyHeroic.ttf");
